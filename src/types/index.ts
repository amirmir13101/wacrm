...
export interface AccountMember extends WorkspaceMember {
...
export interface Conversation {
  ...
  updated_at: string;
  contact?: Contact;
  /** Per-conversation switch for the separate AI Agent auto-reply bot. */
  ai_autoreply_disabled?: boolean;
  /** Replies claimed by the separate AI Agent in this conversation. */
...
export interface Message {
  ...
  /** True only for outbound messages generated by the separate AI Agent. */
