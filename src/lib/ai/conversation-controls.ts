...
export function humanizeAiSkipReason(reason?: string | null): string {
  const reasons: Record<string, string> = {
    ...
    answer_not_found: 'AI paused this conversation because it could not find a safe answer in your knowledge base.',
    ...
    same_response_repeated: 'AI did not reply because it recently sent the same response.',
