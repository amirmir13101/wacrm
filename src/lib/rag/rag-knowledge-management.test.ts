...
describe('RAG manual knowledge management', () => {
  ...
  it('adds the customer-facing Knowledge Base UI without technical internals', () => {
    ...
    expect(page).toContain('Saved Knowledge')
    expect(page).toContain('Chunks ready')
    expect(page).toContain('Manual knowledge progress')
    expect(page).toContain('Ready to save knowledge')
    expect(page).toContain('Content will be saved')
    expect(page).toContain('Saving knowledge...')
    expect(page).toContain('Preparing your content...')
    expect(page).toContain('Creating knowledge chunks...')
    expect(page).toContain('Creating embeddings automatically...')
    expect(page).toContain('Embedding will be created automatically')
    ...
    expect(page).not.toContain('Cleaning content...')
    expect(page).not.toContain('Importing website...')
    expect(page).not.toContain('Reading website content...')
  ...
  it('adds workspace-scoped CRUD routes with the right permissions', () => {
    ...
    expect(listRoute).toContain('recordFailedRagEmbeddingSummary')
    expect(listRoute).toContain('embeddingSummary')
    expect(listRoute).toContain('embeddingWarning')
    expect(listRoute).toContain('sourceType')
    expect(listRoute).not.toContain('createSkippedRagEmbeddingSummary')
    expect(listRoute).not.toContain('shouldAutoEmbedRagKnowledge')
    ...
    expect(detailRoute).toContain('recordFailedRagEmbeddingSummary')
    expect(detailRoute).toContain('embeddingSummary')
    expect(detailRoute).toContain('embeddingWarning')
    expect(detailRoute).toContain('sourceType')
    expect(detailRoute).not.toContain('createSkippedRagEmbeddingSummary')
    expect(detailRoute).not.toContain('shouldAutoEmbedRagKnowledge')
