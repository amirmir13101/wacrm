...
describe('pricing page copy', () => {
  ...
  it('clearly explains the Pro first-month promotional price and renewal price', () => {
    ...
    expect(source).toContain('billing: "$1 first month, then $9.99/month"')
    expect(source).toContain('Eligible new customers pay $1 for the first month once')
    expect(source).toContain('Renewals continue at $9.99/month')
