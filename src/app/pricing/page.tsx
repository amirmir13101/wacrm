  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7fbf8] text-[#07130e]">
      ...
      <section className="relative isolate overflow-hidden bg-[#07130e] text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-5 py-20 sm:px-8 lg:min-h-[660px] lg:grid-cols-[0.94fr_1.06fr] lg:px-10">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-3">
            {plans.map((plan) => (
              ...
              >
                ...
                <Link
                  href={plan.href}
                  className={`mt-7 inline-flex h-12 w-full items-center justify-center rounded-full text-sm font-bold transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${
                    plan.featured
                      ? "bg-[#3ddf84] text-[#07130e] hover:bg-[#ffbd29] focus-visible:outline-white"
                      : "bg-[#181818] text-white hover:bg-[#ffbd29] hover:text-[#07130e] focus-visible:outline-[#08bba4]"
                  }`}
                >
                  {plan.cta}
                </Link>
