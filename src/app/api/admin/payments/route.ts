...
export async function GET(request: Request) {
  ...
  let query = admin
    ...
    .select(
      'id, workspace_id, user_id, plan_type, amount, currency, payment_method, payer_name, payer_email, workspace_name, transaction_reference, note, status, admin_note, approved_at, rejected_at, created_at, updated_at, workspace:workspaces(name, plan_type, subscription_status)',
    )
