...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Refund rules for Talk Wagon CRM trials, subscriptions, lifetime setup, WhatsApp API costs, and fair exception cases.",
    url: canonicalUrl,
    siteName: "Talk Wagon",
    type: "website",
  },
...
export default function RefundPolicyPage() {
  return (
    <InfoPageShell>
      ...
      <InfoSection
        title="Start With the 7-Day Free Trial"
      ...
      >
        <div className="rounded-[26px] border border-[#3ddf84]/35 bg-[#f4fff9] p-6 text-base leading-8 text-[#315345] shadow-[0_18px_45px_rgba(7,19,14,0.08)]">
          <p className="font-semibold text-[#07130e]">
            Customers should use the 7-day free trial to test whether Talk Wagon fits their WhatsApp CRM workflow before
            upgrading or requesting a paid setup.
          </p>
          <p className="mt-4">
            After the trial period, active subscription usage, completed setup work, or configured self-hosted delivery is
            generally non-refundable unless a fair exception applies.
          </p>
        </div>
      </InfoSection>
      ...
      >
        <InfoCardGrid>
          <InfoCard title="After active usage">
            Paid plan usage after the trial period is generally non-refundable once CRM access, workspace features,
