...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    {
      url: `${siteUrl}/whatsapp-api-prices`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.85,
    },
    ...
    {
      url: `${siteUrl}/blog/whatsapp-away-message-examples`,
      lastModified: new Date("2026-07-23"),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${siteUrl}/blog/whatsapp-business-quick-replies`,
      lastModified: new Date("2026-07-23"),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${siteUrl}/blog/whatsapp-commerce-explained`,
      lastModified: new Date("2026-07-24"),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${siteUrl}/blog/integrating-whatsapp-with-crm`,
      lastModified: new Date("2026-07-24"),
      changeFrequency: "monthly",
      priority: 0.7,
    },
