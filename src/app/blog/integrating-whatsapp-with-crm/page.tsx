              ...
              <div className="space-y-12">
                ...
                <SectionHeading id="talkwagon" eyebrow="TalkWagon workflow" title="How TalkWagon supports WhatsApp CRM workflows">
                  ...
                  <p>
                    ...
                    <Link href="/blog/whatsapp-business-quick-replies" className="font-bold text-[#087d68] underline-offset-4 hover:underline">quick replies</Link>,{" "}
                    <Link href="/blog/how-to-schedule-whatsapp-messages" className="font-bold text-[#087d68] underline-offset-4 hover:underline">scheduled WhatsApp messages</Link>, and{" "}
