  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7fbf8] text-[#07130e]">
      ...
      <section className="relative isolate overflow-hidden bg-[#07130e] text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-5 pb-16 pt-9 sm:px-8 sm:pb-16 sm:pt-12 lg:min-h-[650px] lg:grid-cols-[0.92fr_1.08fr] lg:px-10 lg:py-20">
