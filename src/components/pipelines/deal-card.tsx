...
export function DealCard({ deal, stage, onEdit, isOverlay }: DealCardProps) {
  ...
  return (
    <button
      ...
      className={`group relative w-full cursor-pointer rounded-xl border border-[#3ddf84]/60 bg-slate-800/70 pl-4 pr-3 py-3 text-left shadow-sm transition-all ${
        isOverlay
          ? "shadow-xl"
          : "hover:-translate-y-0.5 hover:border-[#3ddf84]/80 hover:bg-slate-800 hover:shadow-lg"
      }`}
    >
